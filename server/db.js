            ...
            r.table('user')
              .insert(
                {
                  ...
                  profile_image_url: profile._json.profile_image_url_https.replace(
                    '_normal',
                    '_400x400',
                  ),
              ...
              .then(result => {
                if (result && result.inserted == 1) {
                  ...
                  axios
                    .get(`${_config.api.baseURL}/user/me/welcome`, {
                      headers: {
